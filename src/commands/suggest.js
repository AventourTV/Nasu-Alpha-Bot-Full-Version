const { SlashCommandBuilder, ChatInputCommandInteraction, ModalBuilder, TextInputBuilder, TextInputStyle, ActionRowBuilder, ButtonBuilder, ButtonStyle, EmbedBuilder } = require('discord.js');
...
module.exports = {
    ...
    /**
     * Command handler for creating a suggestion
     * @param {Object} param0
    ...
    run: async ({ interaction }) => {
        try {
            ...
            await modalInteraction.editReply('Suggestion created!');
