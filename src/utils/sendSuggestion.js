 ...
 */
async function sendSuggestion(interaction, from) {
  ...
  try {
    if (from === "command") suggestionMessage = await interaction.channel.send('Creating suggestion, please wait...');
  } catch (error) {
  ...
  if (from === "command") {
    ...
    const channel = interaction.client.channels.cache.get(
      // change this with your suggestions channel ID
      '1301073379566026776'
    );
